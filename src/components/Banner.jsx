...
import headerImg2 from "../assets/img/block.svg";
                ...
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7}>
                        ...
                        <div className={isVisible}>
                            <h1>{"Hallo Saya Ilham Munawar "}<br></br><span className="wrap" id='el'>{curWord}</span><span className='cursor'>|</span></h1>
                                <p>Latar belakang saya adalah sebagai mahasiswa informatika di sebuah politeknik di Indonesia, Senang bertemu dengan Anda.</p>

...
import gambar2 from '../assets/logo/html5.png';
import gambar3 from '../assets/logo/capcut-logo-1.png';
import gambar4 from '../assets/logo/php.png';
                    ...
                    {({isVisible}) =>
                        <div className={isVisible}>
                            <AnimationOnScroll animateIn='animate__fadeIn'>
                                ...
                                <h2>Skills & Tools</h2>
                                <p className='mb-2'>Skills and tools that I can use in developing a website</p>
                                <Carousel responsive={responsive} infinite={true} className='skill-slider pt-7'>
                                    <div className='item'>
